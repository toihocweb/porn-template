...
(function($) {
  $.fn.smoothScroll = function(animate_name, time) {
...
// btn
$('[class~="btn-ripple"]').click(function(e) {
  // Remove any old one
  $(".ripple").remove();
      ...
      if (
        ...
        var i =
          ...
          s =
            '<a href="tel:' +
            f.phoneBtn +
            '" class="a-top call-btn-mobile ' +
            n +
            '"><svg id="icon-phone"></svg></a>',
          t =
            '<a href="' +
            f.locationBtn +
            '" class="a-top location-btn-mobile ' +
            n +
